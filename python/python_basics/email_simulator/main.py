...
''' Practice using datetime module formatting

current_time = datetime.datetime.now()
print(current_time.strftime('%H:%M:%S'))            # 17:13:41
print(current_time.strftime('%Y-%m-%d %H:%M:%S'))   # 2026-07-07 17:14:23

'''

''' Testing User and Inbox classes and their respective methods/objects
...
''' Testing Email class and its respective methods/objects
